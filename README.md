...
[![CodeNection 2026](https://img.shields.io/badge/CodeNection-2026-1F6B4F?logo=codeigniter&logoColor=white)](https://itsocietymmu.com/codenection-2026/)
[![Track](https://img.shields.io/badge/Track-Stress%20%26%20Workload%20Manager-blue?logoColor=white)](#-1-project-overview)
[![React](https://img.shields.io/badge/React-19-61DAFB?logo=react&logoColor=black)](https://react.dev/)
[![Vite](https://img.shields.io/badge/Vite-8-646CFF?logo=vite&logoColor=white)](https://vite.dev/)
[![Tailwind CSS](https://img.shields.io/badge/Tailwind_CSS-v4-38B2AC?logo=tailwind-css&logoColor=white)](https://tailwindcss.com/)
[![Python](https://img.shields.io/badge/Python-3.13-3776AB?logo=python&logoColor=white)](https://www.python.org/)
[![FastAPI](https://img.shields.io/badge/FastAPI-0.115-009688?logo=fastapi&logoColor=white)](https://fastapi.tiangolo.com/)
[![Google Gemini API](https://img.shields.io/badge/GenAI-Google%20Gemini%20API-4285F4?logo=google&logoColor=white)](https://ai.google.dev/)
[![SQLite](https://img.shields.io/badge/Database-SQLite%20Async-003B57?logo=sqlite&logoColor=white)](https://sqlite.org/)
...
**Video Presentation**: [Unlisted YouTube Video Link](https://youtu.be/rTSTv5_J3HM?si=8cKCWk8ARzjgc5gi)  
**Presentation Slides**: [Public Presentation Slides Link](https://canva.link/209ygsdv7ul2evl)   
...
```mermaid
graph TD
    Root[🚨 Crisis: Student Burnout & Cognitive Exhaustion]
    
    Branch1[Academic Overload]
    Branch2[Fragmented Energy Tracking]
    Branch3[Guilt-Driven Productivity Culture]
    
    Root --> Branch1
    Root --> Branch2
    Root --> Branch3
    
    Cause1A[FYP, Exams & Deadlines Clumping] --> Branch1
    Cause1B[Underestimating Task Completion Time] --> Branch1
    
    Cause2A[Ignoring Physical Sleep Deficit] --> Branch2
    Cause2B[Separating Social/Errands from Work] --> Branch2
    
    Cause3A[Red Overdue Badges Cause Panic] --> Branch3
    Cause3B[No Safe Way to Postpone Without Shame] --> Branch3
```
...
```mermaid
graph LR
    A[Student Inputs Thought] --> B[Smart NLP Capture]
    B --> C[Assign Category & Hours]
    C --> D[Calculate Capacity 0-100%]
    D --> E{Capacity > 75%?}
    E -- No --> F[Equilibrium & Focus]
    E -- Yes --> G[Trigger Impending Overload Alert]
    G --> H[Generate AI Rebalance Plan]
    H --> I[Student Accepts in 1-Click]
    I --> J[Load Rebalanced & Rest Protected]
```
...
![Landing Page](./Lumora%20Pages/Landing%20Page.png)
...
![Dashboard Page](./Lumora%20Pages/Dashboard%20Page.png)
...
![Smart Capture](./Lumora%20Pages/Capture%20Task.png)
...
![What-If Sidebar](./Lumora%20Pages/What-If%20SIdebar.png)
...
![Academic & Focus](./Lumora%20Pages/Academic%20&%20Focus.png)
...
![Mood & Stress](./Lumora%20Pages/Mood%20&%20Stress.png)
...
![Physical & Sleep](./Lumora%20Pages/Physical%20&%20Sleep.png)
...
![Social & Errands](./Lumora%20Pages/Social%20&%20Errands.png)
...
![Recovery Page](./Lumora%20Pages/Recovery%20Page.png)
...
![All Task Page](./Lumora%20Pages/All%20Task%20Page.png)
...
![Sign Up Page](./Lumora%20Pages/Sign%20Up%20Page.png)
...
graph TD
    subgraph Client [Frontend — React 19 + Vite]
        UI[User Interface & Bento Grid]
        Calendar[Multi-View Calendar: Daily/Weekly/Monthly]
        WhatIf[What-If Floating Assistant]
        CaptureModal[NLP Smart Capture Modal]
        RebalanceUI[1-Click Rebalance Modal]
    end

    subgraph API_Gateway [FastAPI Backend Service]
        Router[REST API Endpoints /api/*]
        AuthService[Auth & Session Manager]
        WorkloadEngine[Deterministic 0-100% Capacity Engine]
        RebalanceEngine[Autonomous Rebalance Heuristic Algorithm]
        DecisionSimulator[What-If Scenario Projection Engine]
    end

    subgraph AI_Services [External & Local AI Engine]
        GeminiAPI[Google Gemini 2.5/2.0 API]
        LocalParser[Offline Heuristic NLP Fallback Parser]
    end

    subgraph Storage [Persistence Layer]
        DB[(SQLite Async Database / aiosqlite)]
        SeedData[Demo State: Alex Chen Profile]
    end
    ...
    Router --> AuthService
    Router --> WorkloadEngine
    Router --> RebalanceEngine
    Router --> DecisionSimulator

    CaptureModal --> GeminiAPI
    GeminiAPI -.->|Fallback on error| LocalParser
    LocalParser --> Router

    WorkloadEngine --> DB
    RebalanceEngine --> DB
    DecisionSimulator --> DB
    AuthService --> DB
```
