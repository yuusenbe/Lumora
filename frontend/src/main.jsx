...
class ErrorBoundary extends Component {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="min-h-screen bg-[#F8F9F3] flex flex-col items-center justify-center p-6 text-center">
          <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-lg border border-[#E2E8DF] space-y-4">
            <div className="w-12 h-12 mx-auto rounded-full bg-red-50 text-red-600 flex items-center justify-center font-bold text-xl">
              !
            </div>
            <h2 className="text-xl font-bold text-[#354546]">Something went wrong</h2>
            ...
            <div className="flex gap-2 pt-2">
              <button
                ...
                className="flex-1 py-2.5 px-4 rounded-xl bg-[#88A788] text-white text-xs font-bold hover:bg-[#759475] transition-colors"
              >
                Refresh Page
              </button>
              <button
