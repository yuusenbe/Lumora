        ...
        <div className="lumora-card p-6 sm:p-8 space-y-5 bg-white border border-[#D2E2D8] shadow-lg">
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-[#152F26]">Full Name</label>
              <input
                type="text"
                required
                value={name}
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-[#152F26]">Student Email</label>
              <input
                type="email"
                required
                value={email}
          ...
          <button
            type="button"
            onClick={() => demoLogin()}
            className="w-full py-2.5 px-4 rounded-xl bg-[#E3F2E9] hover:bg-[#C2E2D0]/60 border border-[#C2E2D0] text-[#152F26] text-xs font-bold transition-all flex items-center justify-center space-x-2 cursor-pointer shadow-2xs"
          >
          ...
          <div className="text-center pt-2 border-t border-[#D2E2D8]">
            <span className="text-xs text-[#4A675E]">Already have an account? </span>
            <button
